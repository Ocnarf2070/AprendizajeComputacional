d.test <- read.csv("testing/test.csv", stringsAsFactors=F)
d.train  <- read.csv("training/training.csv", stringsAsFactors=F)
...
d.submission <- read.csv("C:/facial_keypoint_detection/SampleSubmission.csv")
...
train.file<-'training/training.csv'
